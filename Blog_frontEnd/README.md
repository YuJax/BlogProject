...
- [Admin One — Free Vue 3.x Tailwind 3.x Admin Dashboard with dark mode](#admin-one--free-vue-3x-tailwind-3x-admin-dashboard-with-dark-mode)
    - [Tailwind 3.x Vue 3.x with Vite or Nuxt or Laravel](#tailwind-3x-vue-3x-with-vite-or-nuxt-or-laravel)
    - [Tailwind 3.x Vue 3.x with Vite or Nuxt or Laravel](#tailwind-3x-vue-3x-with-vite-or-nuxt-or-laravel-1)
  - [Table of Contents](#table-of-contents)
  - [Looking for React TypeScript version?](#looking-for-react-typescript-version)
  ...
  - [Quick Start](#quick-start)
    ...
    - [Vite builds](#vite-builds)
      ...
      - [Serves recently built app](#serves-recently-built-app)
    - [Linting](#linting)
      - [Lint](#lint)
